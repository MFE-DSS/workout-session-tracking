...
# Worker policy. `auto` matches the historical CI behaviour; the environment
# override exists so a mitigation can be measured on real CI without editing
# the canonical flag set.
CI_PYTEST_WORKERS="${CI_PYTEST_WORKERS:-auto}"
