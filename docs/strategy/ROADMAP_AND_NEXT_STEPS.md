...
| **Prochaine action** | **Vérifier CI verte** sur push Sb_UI_02b.1. **Puis human review** (comparaison `var/visual-after/Sb_UI_05_1/home-*` teal vs `Sb_UI_02b_1/home-*` terminal — critère : « terminal graphite/mono/ambre, plus wellness »). **Puis proposition `Sb_UI_02b.2 Focus Re-skin`** sur override. `Sb_UI_05.2` et `Sx_UI_06` différés. Options différables : release tag baseline preauren, mini-gate 57 kg, cleanup warnings infra. |
| Ruff budget | **534 ≤ 548** |
