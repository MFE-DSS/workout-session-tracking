...
| Sb_32.next.worked-area-descriptor-ui | 🟡 **READY TO BE PROPOSED, not opened** 2026-07-09. Consommer `body_map_descriptor` (`.3`) dans l'UI Worked Area (SSR), review-gated. Premier consommateur réel du descriptor. Sur override explicite opérateur. |
...
| **Prochaine action** | `Sb_32.3` **accepté** ✅ + `Sb_OPS.scope-guard` **accepté** ✅. Cycle Sx_32 **in progress**. Arbitrage prochain : ouvrir `Sb_32.next.worked-area-descriptor-ui` (1er consommateur du descriptor, SSR) **ou** `Sb_32.4` (bascule consommateurs métier). Sur override explicite. Options différables : release tag, mini-gate 57 kg, cleanup warnings infra, fix trait sparkline `timeline.py`, `Sb_UI_05.2` (deferred), closeout dogfoods Sx_30/31. |
| Ruff budget | **534 ≤ 548** |
