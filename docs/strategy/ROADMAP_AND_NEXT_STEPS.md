...
| **Prochaine action** | **Vérifier CI verte** sur push Sb_UI_05.1. **Puis human review** (comparaison visuelle `var/visual-after/Sb_UI_05_1/home-*` — critère : « le Home me dit quoi faire, pas un dashboard »). **Puis proposition `Sb_UI_05.2 Active Session / Next Workout Cards`** sur override. `Sx_UI_06` future, not opened. Options différables : release tag baseline preauren, mini-gate 57 kg, cleanup warnings infra. |
| Ruff budget | **534 ≤ 548** |
