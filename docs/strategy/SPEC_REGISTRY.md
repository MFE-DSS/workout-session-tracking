...
| Sb_31.2 | Route `GET /body/intelligence` + couche I/O + template + CSS dédié (30 tests) | ✅ | Sx_31 §N.2 | `SPRINT_Sb_31_2_body_route_and_inputs_BUILD_REPORT.md` | (post-push) | Collision `/body` (track Body Manual Profile PR #15) résolue via `/body/intelligence` ; 240 l service I/O + 47 l router + 209 l template + 230 l CSS ; 0 migration / 0 JS / 0 service métier core muté ; pipeline `inputs → compute_body_intelligence → template` |
