...
| Sx_UI_04 | Session Focus Reskin — 5 sous-sprints proposés (`Sb_UI_04.1` CSS foundation → `.5` polish + closure), OQ-I/J/K/M/AC/AD/AE tranchées V1, OQ-H hex pending merge Sb_UI_04.1 | ✅ **SPEC ACCEPTED — human reviewed** 2026-07-02 + 🟡 **`Sb_UI_04.1` BUILD READY TO BE PROPOSED** — **baseline P0 CAPTURED locally 2026-07-04** (16/16 PNG via Sb_UI_11.2 runtime CLI), précondition dure satisfaite, aucune dérogation nécessaire | Sx_UI_11 accepté ✅ + baseline P0 ✅ | Non (spec docs-only) ; `Sb_UI_04.k` = Oui (surface uniquement) | [`SPRINT_Sx_UI_04_REPORT.md`](../SPRINT_Sx_UI_04_REPORT.md) + [`SPRINT_Sx_UI_04_HUMAN_REVIEW_REPORT.md`](../SPRINT_Sx_UI_04_HUMAN_REVIEW_REPORT.md) + [`Sx_UI_04_SESSION_FOCUS_RESKIN_SPEC.md`](Sx_UI_04_SESSION_FOCUS_RESKIN_SPEC.md) + [`BASELINE_P0_CAPTURED_2026_07_04.md`](../BASELINE_P0_CAPTURED_2026_07_04.md) |
