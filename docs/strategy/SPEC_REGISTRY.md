...
| Sb_30.2 | overload_explainer.py + overload_inputs.py + injection router (42 tests) | ✅ | Sx_30 §14 | `SPRINT_Sb_30_2_REPORT.md` | (post-push) | +259 lignes services (84 explainer + 175 inputs) ; +14 lignes router ; 0 template / 0 migration / 0 modèle / 0 CSS / 0 JS ; 0 service métier core mutually modifié |
