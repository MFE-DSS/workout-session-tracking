...
| Sb_27.4 | Recommendation explanation (wrapper externe) | 🟢 | Sx_27 §14 | `SPRINT_Sb_27_4_REPORT.md` | (post-push) | OQ-4 tranchée : wrapper externe, recommendation.py NON modifié |
