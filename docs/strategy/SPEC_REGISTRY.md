...
| **Sx_31 CLOSURE** | Technically closed — dogfood device réel pending | ✅ TECH CLOSED | `Sx_31_CLOSURE_REPORT.md` + `dogfood/DOGFOOD_Sx_31_BODY_INTELLIGENCE_TEMPLATE.md` | — | [28322377053](https://github.com/MFE-DSS/workout-session-tracking/actions/runs/28322377053) ✅ | 5/7 OQ implémentées (OQ-F home-card + OQ-G profile-link différées sous override séparé). Sx_32/33+ restent bloqués. |
