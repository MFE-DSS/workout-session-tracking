...
| Sb_30.4 | Suppression `progression_hint.py` legacy + 3 garde-fous | ✅ | Sx_30 §14 | `SPRINT_Sb_30_4_remove_progression_hint_legacy_BUILD_REPORT.md` | (post-push) | -184 lignes legacy (50 service + 134 tests) ; -13 router net ; -4 template net ; Ruff 535 → 528 ; 0 service core touché ; 0 migration |
