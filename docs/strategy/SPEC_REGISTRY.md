...
| **Sx_30 CLOSURE** | Technically closed — dogfood device réel pending | ✅ TECH CLOSED | `Sx_30_CLOSURE_REPORT.md` + `dogfood/DOGFOOD_Sx_30_OVERLOAD_ENGINE_TEMPLATE.md` | — | [28288760013](https://github.com/MFE-DSS/workout-session-tracking/actions/runs/28288760013) ✅ | OQ-E livrée via `Sb_30.next.placeholder` 2026-06-27. Sx_31/32/33+ restent bloqués. |
...
| Sb_31.5 | Closure docs + dogfood template (DOC only) | ✅ | Sx_31 §N.2 | `SPRINT_Sb_31_5_body_intelligence_closure_BUILD_REPORT.md` | (post-push) | Doc only ; 0 code applicatif modifié ; closure + dogfood template livrés |
| **Sx_31 CLOSURE** | Technically closed — dogfood device réel pending | ✅ TECH CLOSED | `Sx_31_CLOSURE_REPORT.md` + `dogfood/DOGFOOD_Sx_31_BODY_INTELLIGENCE_TEMPLATE.md` | — | (Sb_31.5 CI run) | 5/7 OQ implémentées (OQ-F home-card + OQ-G profile-link différées sous override séparé). Sx_32/33+ restent bloqués. |
