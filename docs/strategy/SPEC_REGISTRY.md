...
| **Sx_31** Body Intelligence v2 | SPEC ONLY ouverte sous override #4 (post-closure Sx_30) | 🟡 SPEC ONLY | `SPIGNOS_BODY_INTELLIGENCE_V2_SPEC.md` | `SPRINT_Sx_31_body_intelligence_v2_REPORT.md` | [28300352085](https://github.com/MFE-DSS/workout-session-tracking/actions/runs/28300352085) ✅ 3/3 | Consolidation lecture corporelle dérivée training ; nouvelle route `/body` ; 0 mutation services métier core ; 0 migration V1 ; OQ-A→OQ-G à trancher avant Sb_31.1 ; track séparé Body Signal Model parallèle inchangé |
