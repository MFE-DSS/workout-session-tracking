...
| Sb_30.1 | overload_engine.py v1 + tests unitaires (33 cas) | ✅ | Sx_30 §14 | `SPRINT_Sb_30_1_REPORT.md` | (post-push) | Moteur pur 260 lignes ; 0 router/template/migration/modèle ; 0 service métier core touché ; OQ A/B/C/D implémentées |
