...
| Sx_UI_04 | Session Focus Reskin — **premier sprint code visuel autorisé, non-autorisé maintenant** | 🚫 **BLOCKED** — requires Sx_UI_11 accepted + baseline P0 available (14 screenshots min) + OQ résiduelles Sx_UI_02 tranchées (OQ-H hex, OQ-I sans, OQ-J mono, OQ-K scale, OQ-M naming) + OQ-R Progression sub-nav | Sx_UI_11 accepté + baseline P0 **required first** OU dérogation opérateur explicite | Oui (surface) | — |
...
| Sx_UI_11 | Screenshot Regression Baseline — protocole (Playwright, 18 écrans × 2 viewports, P0/P1/P2, fixture locale déterministe, révue humaine primaire) | 🟢 **SPEC delivered — pending human review** 2026-07-02 | Sx_UI_03 accepted ✅ | Non (docs) — build tooling Sb_UI_11.1 séparé | [`SPRINT_Sx_UI_11_REPORT.md`](../SPRINT_Sx_UI_11_REPORT.md) + [`Sx_UI_11_SCREENSHOT_REGRESSION_BASELINE_SPEC.md`](Sx_UI_11_SCREENSHOT_REGRESSION_BASELINE_SPEC.md) |
