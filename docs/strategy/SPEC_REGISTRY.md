...
| Sb_30.3 | Migration overload_engine_version + overload_hint.html + CSS + wire (19 tests) | ✅ | Sx_30 §14 | `SPRINT_Sb_30_3_overload_hint_ui_first_render_BUILD_REPORT.md` | (post-push) | Migration `6h9e4c0d1f32` ; partial 41 l + CSS +132 l ; exercise_card.html +9 l (active card only) ; 0 changement engine/inputs/explainer/scoring/legacy |
