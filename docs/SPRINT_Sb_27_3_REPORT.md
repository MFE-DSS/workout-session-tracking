...
Run CI [#27511608805](https://github.com/MFE-DSS/workout-session-tracking/actions/runs/27511608805) (commit `3c0a736`) — conclusion **success** :
...
- [x] Pas de régression sur les gates Sb_26.1 → Sb_27.2
...
| gitleaks passe | ✅ run #27511608805 |
