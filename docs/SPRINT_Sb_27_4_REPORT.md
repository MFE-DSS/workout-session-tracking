...
Run CI [#27531258753](https://github.com/MFE-DSS/workout-session-tracking/actions/runs/27531258753) (commit `7950ac3`) — conclusion **success** :
...
- [x] Pas de régression sur les gates Sb_26.1 → Sb_27.3
...
| gitleaks passe | ✅ run #27531258753 |
