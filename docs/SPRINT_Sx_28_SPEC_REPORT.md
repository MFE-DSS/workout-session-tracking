...
Run CI [#27554090915](https://github.com/MFE-DSS/workout-session-tracking/actions/runs/27554090915) (commit `889284d`) — conclusion **success** :
...
- [x] Pas de régression sur les gates Sb_26.1 → Sb_27.7
...
| gitleaks passe | ✅ run #27554090915 |
