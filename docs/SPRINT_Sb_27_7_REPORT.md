...
Run CI [#27545919573](https://github.com/MFE-DSS/workout-session-tracking/actions/runs/27545919573) (commit `cbbe9ce`) — conclusion **success** :
...
- [x] Pas de régression sur les gates Sb_26.1 → Sb_27.6

CI verte **du premier push**. Cycle Sx_27 techniquement clos.
...
| gitleaks passe | ✅ run #27545919573 |
